...
public class SearchArgs {
  ...
  @Option(name = "-slr", usage = "Use SLR model for index searching. Unless -slr.py is specified input is assumed to be preprocessed as whitespace separated activation values")
